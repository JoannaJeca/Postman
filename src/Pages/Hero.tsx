    ...
    <div className="mx-[30px] h-[50vh] mb-[150px]  flex items-center justify-center">
      <div className=" w-[49%] h-[100%] flex items-end justify-end">
        <div className="w-[73%] h-[60%]">
          ...
          <div className="text-[17.5px] mr-5">
            Over 25 million developers use Postman. Get started by signing up or
          ...
          <div>
            <p className="text-gray-600 text-[13px] font-[500]">
      ...
      <div className=" w-[75%] h-[85%] self-start">
        <img
          src="https://www.postman.com/_wp-assets/home/21bd14bd629f14c1.png"
          alt=""
          width="100%"
          height="80%"
